...
* `Customer_Churn_Prediction` - Clean, comment-annotated Jupyter Notebook documenting data preparation scripts, model configurations, and output visualizations.
